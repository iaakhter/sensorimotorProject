...
class eyeCameraTrain:
    ...
    def __init__(self):
        ...
        self.f = open("trainingData/trainingGaussianLabelXY.txt",'w')
        self.fFeatures = open("trainingData/trainingGaussianFeatureXY.txt",'w')
    ...
    def setUpSystem(self):
        ...
        if self.saveExample:
            ...
            imageName = "trainingData/trainingImagesGaussian/image"
        ...
        if self.setTrainingExample:
            ...
            # Get the target rotation axis and angle from the model given the Initial orientation and the sampled innervation signal
